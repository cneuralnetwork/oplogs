      ...
      <aside className="sidebar">
        ...
        <nav aria-label="Primary navigation">
          {navigation.map((item) => {
            ...
            return (
              <button key={item.path} className="nav-item" data-active={active} onClick={() => navigate(item.path)} aria-current={active ? 'page' : undefined}>
                <item.icon />
        ...
        <button className="nav-item" data-active={currentPath === '/settings'} onClick={() => navigate('/settings')}>
          <SettingsIcon />
          <span>Settings</span>
        </button>
        {footer}
