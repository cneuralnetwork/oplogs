...
export const SettingsIcon = (props: IconProps) => <Mark {...props}><path {...stroke} d="M12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm0-5v2m0 13v2m8.5-8.5h-2m-13 0h-2m14.5-6L16.6 7.4M7.4 16.6 6 18m12 0-1.4-1.4M7.4 7.4 6 6" /></Mark>
